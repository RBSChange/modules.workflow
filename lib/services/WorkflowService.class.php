...
class workflow_WorkflowService extends f_persistentdocument_DocumentService
{
	...
	public function getNewDocumentInstance()
	{
		...
		$startPlace->setLabel(LocaleService::getInstance()->trans('m.workflow.bo.general.autogenerated-startplace', array('ucf')));
		...
		$endPlace->setLabel(LocaleService::getInstance()->trans('m.workflow.bo.general.autogenerated-endplace', array('ucf')));
	...
	public function isPublishable($document)
	{
		...
		{
			$this->setActivePublicationStatusInfo($document, 'm.workflow.bo.general.error-anothervalidworkflowoninterval');
			return false;
		}
